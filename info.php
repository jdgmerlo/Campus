        ...
        <div id="contenedor-principal">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <p class="text-info">Esta Plataforma Interatactiva es de uso exclusivo para profesores y alumnos del Instituto Superior de Formaci&oacute;n T&eacute;cnica N° 177.</p>
                    <br />
                    <p class="text-info">Condiciones de Uso.</p>
                    <ul class="text-uppercase">
                        <li>Profesor</li>
                        <li>Alumno Regular</li>
                    </ul>
                    <p class="text-info">La Plataforma contiene tres roles:  <strong>ADMINISTRADOR</strong>, <strong>PROFESOR</strong> y <strong>ALUMNO</strong></p>
                </div>
                <div class="col-md-2">
